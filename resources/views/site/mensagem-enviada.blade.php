...
<!-- End Meta Pixel Code -->
    ...
    <style>
      #sitebg {position:relative; background-size: 100%; background-attachment: fixed; background-position:top;}
    </style>
  ...
  <script type="text/javascript">
    ...
    if (document.body) {
        if (7 <= currentTime && currentTime < 18) {
          document.getElementById('sitebg').style.backgroundImage="url(background-maringa.png)";
          
        }
        else {
            document.getElementById('sitebg').style.backgroundImage="url(background-maringa-noite.jpg)";
        }
    }
  </script>
