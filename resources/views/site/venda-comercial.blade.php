...
<html lang="pt-br">
  <head>
    ...
    <title>Imóveis Comerciais à Venda em Maringá e Região</title>
    <meta name="description" content="Silvio Iwata Prime - Vendas Especiais. Lojas, Salões, Barracões à Venda em Maringá e Região. Veja a Lista De Imóveis Selecionados.">
    <meta charset="utf-8">
    <meta name="robots" content="index, follow">      
    <link rel="canonical" href="{{route('venda.comercial')}}"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
    <meta property="og:url" content="{{route('venda.comercial')}}" />
    <meta property="og:title" content="Silvio Iwata Prime - Lojas, Salões, Barracões à venda em Maringá e Região." />
    <meta property="og:image" content="logo.png" />
    <meta property="og:description" content="Silvio Iwata Prime - Vendas Especiais. Lojas, Salões, Barracões à Venda em Maringá e Região. Veja a Lista De Imóveis Selecionados." />
    <meta name="theme-color" content="#174d29">
    <meta property="business:contact_data:country_name" content="Brasil" />
    <meta property="business:contact_data:website" content="{{route('venda.comercial')}}" />
    ...
    <meta name="twitter:description" content="Silvio Iwata Prime - Vendas Especiais. Lojas, Salões, Barracões à Venda em Maringá e Região. Veja a Lista De Imóveis Selecionados."/>
    <meta name="twitter:title" content="Silvio Iwata Prime - Lojas, Salões, Barracões à venda em Maringá e Região." />
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            ...
            <h1 style="color:#1d5539;text-align: center;font-size: 1.3em">Imóveis Comerciais à Venda Selecionados Para Você</h1>
            </div>
          </div>
        </div>
        <div class="row mb-5">
          ...
          <div class="col-md-12 text-center">
            <div class="site-pagination">
              @for ($i = 1; $i <= $imoveis->lastPage(); $i++)
                <a href="{{route('venda.comercial')}}?page={{$i}}" class="{{$imoveis->currentPage() == $i ? 'active' : ''}}" >{{$i}}</a>
              @endfor
            </div>
          </div>  
        </div>
