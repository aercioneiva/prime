...
<!-- End Google Tag Manager -->
     <title>Silvio Iwata Prime - Lançamentos De Imóveis Em Maringá E Região</title>
     <meta name="description" content="Silvio Iwata Prime - Apartamentos Prontos Para Morar, Em Obras e Na Planta.">
    <meta charset="utf-8">
   <meta name="robots" content="index, follow">      
    <link rel="canonical" href="{{route('lancamentos')}}"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"> 
    <meta property="og:url" content="{{route('lancamentos')}}" />
    <meta property="og:title" content="Silvio Iwata Prime - Lançamentos De Imóveis Em Maringá E Região." />
    <meta property="og:image" content="logo.png" />
    <meta property="og:description" content="Silvio Iwata Prime - Apartamentos Prontos Para Morar, Em Obras e Na Planta." />
    <meta name="theme-color" content="#174d29">
    <meta property="business:contact_data:country_name" content="Brasil" />
    <meta property="business:contact_data:website" content="{{route('lancamentos')}}" />
    ...
    <meta name="twitter:description" content="Silvio Iwata Prime - Apartamentos Prontos Para Morar, Em Obras e Na Planta."/>
    <meta name="twitter:title" content="Silvio Iwata Prime - Lançamentos De Imóveis Em Maringá E Região." />
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12">
            ...
            <h1 style="color:#1d5539;text-align: center;font-size: 1.3em;">Lançamentos De Imóveis Selecionados Para Você</h1>
            </div>
          </div>
        </div>
        <div class="row mb-5">
          @foreach ($imoveis as $imovel)
            <div class="col-md-6 col-lg-4 mb-4">
              <a href="{{route('propriedade', ['id' => $imovel->id, 'slug' => $imovel->slug])}}" class="prop-entry d-block">
                <figure>
                  <img src="{{asset('storage/'.$imovel->nome_imagem)}}" alt="Imóveis Comerciais À Venda" class="img-fluid">
                </figure>
                <div class="prop-text">
                  <div class="inner">
